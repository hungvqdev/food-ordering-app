            ...
            orders.map((order) => {
              return (
                <div className="border border-2 m-2 row">
                  ...
                  <div id='info_order' className="col-md-6 col-12 orders_p_address p-3 order_border_top">
                    <p>
                      Thời gian đặt hàng: <span >{order.createdAt.substring(0, 10)}</span> 
                    </p>
                    <p>Người nhận: <span>{order.name}</span> </p>
                    <p>
                      Dịa chỉ nhận hàng: <span>{order.shippingAddress.street},
                      {order.shippingAddress.city}</span> 
                    </p>
                    <p>Phương thức thanh toán: <img src={images.visa}  alt="Visa, Master" style={{ width: "25px", height: "25px" }} /> <span>Thẻ quốc tế (Visa, Master ...)</span> </p> 
                    <p>Tổng tiền: <span>{order.orderAmount}.000đ</span> </p>
                  </div>
                </div>
              );
            })}
